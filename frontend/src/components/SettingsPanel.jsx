      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          {availableModels.length > 0 ? (
            <select 
              className="w-full px-4 py-2 glass-input appearance-none bg-white/40"
        ...
        <button 
          ...
          className="w-full mt-2 flex items-center justify-center gap-2 py-2 px-4 glass-input hover:bg-white/80 text-sm font-medium text-gray-700"
        >
        ...
        {status === 'discovering' && (
          <div className="flex items-center gap-2 text-blue-600 text-sm p-3 bg-blue-50/80 backdrop-blur rounded-xl">
        ...
        {status === 'connected' && (
          <div className="flex items-center gap-2 text-green-700 text-sm p-3 bg-green-50/80 backdrop-blur rounded-xl border border-green-200/50">
            <CheckCircle2 className="w-4 h-4 flex-shrink-0" /> Connected to Local LLM
          </div>
        )}

        {status === 'error' && (
          <div className="flex items-center gap-2 text-red-600 text-sm p-3 bg-red-50/80 backdrop-blur rounded-xl border border-red-200/50 break-all">
